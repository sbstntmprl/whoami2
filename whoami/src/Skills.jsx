...
function Skills() {
  return (
    <section className='sm:h-auto 2xl:h-screen flex flex-col items-center pl-20'>
      <div className='flex flex-col gap-8 text-center p-10 text-text'>
        <h1 className='sm:text-4xl md:text-6xl text-left'>Skills</h1>
        ...
        <h1 className='sm:text-4xl md:text-6xl text-left'>MERN Stack</h1>
      ...
      <div className='flex gap-20 sm:flex-col sm:gap-10 lg:flex-row'>
        <div className='flex flex-col items-center gap-5'>
          <SiMongodb className=' text-[#3d6891] sm:w-20 sm:h-20 md:w-36 md:h-36' />
          <h2 className='sm:text-2xl text-text text-4xl'>MongoDB</h2>
        </div>

        <div className='flex flex-col items-center gap-5'>
          <SiExpress className='text-[#3d6891] sm:w-20 sm:h-20 md:w-36 md:h-36' />
          <h2 className='sm:text-2xl text-text text-4xl'>ExpressJS</h2>
        </div>

        <div className='flex flex-col items-center gap-5'>
          <RiReactjsFill className='text-[#3d6891] sm:w-20 sm:h-20 md:w-36 md:h-36' />
          <h2 className='sm:text-2xl text-text text-4xl'>ReactJS</h2>
        </div>

        <div className='flex flex-col items-center gap-5'>
          <FaNodeJs className='text-[#3d6891] sm:w-20 sm:h-20 md:w-36 md:h-36' />
          <h2 className='sm:text-2xl text-text text-4xl'>NodeJS</h2>
        </div>
      </div>
    </section>
  )
