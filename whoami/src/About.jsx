  ...
  return (
    <section className='h-auto flex flex-col items-center pl-20'>
      <div className='flex flex-col gap-8 text-center p-10 text-text'>
        <h1 className='sm:text-4xl md:text-6xl'>WhoAmI</h1>
        ...
        <h1 className='sm:text-4xl md:text-6xl'>Education</h1>
        ...
        <div className='flex flex-wrap gap-10 w-auto justify-center'>
          <div className='flex gap-20 justify-center'>
            <div className='bg-secondary text-background flex gap-5 p-10 rounded-xl w-auto'>
              <img className='rounded-xl w-80' src={pup} alt="" />
          ...
          <div className='flex flex-wrap gap-20 justify-center'>
            <div className='bg-secondary text-background flex gap-5 p-10 rounded-xl w-auto'>
              <img className='rounded-xl w-80' src={uplift} alt="" />
          
              <div className='flex flex-col items-center gap-3 w-96'>
                <p>2023-2024</p>
                <h2 className='text-3xl'>Uplift Code Camp </h2>
                <p>Full-Stack Web Development</p>
                <p>Completed 6 Web Application Projects</p>
